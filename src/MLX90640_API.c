...
int MLX90640_TriggerMeasurement()
{
    int error = 1;
    uint16_t ctrlReg;
    
    error = MLX90640_I2CRead16(0x800D, 1, &ctrlReg);
    ...
    ctrlReg |= 0x8000;
    error = MLX90640_I2CWrite16(0x800D, ctrlReg);
...
int MLX90640_SetResolution(uint8_t resolution)
{
    ...
    if(error == 0)
    {
        ...
        error = MLX90640_I2CWrite16(0x800D, value);        
    }    
